...
## 分析要件:
まず、上記のニュース記事全体の内容を簡潔に要約してください（3〜5文程度）。主要なトピック、市場への影響、注目すべきポイントをまとめてください。

次に、上記のニュースから上位3〜5の投資テーマを特定し、各テーマについて日本株の推薦銘柄を提示してください。

以下のJSON構造で回答してください:

{
  "newsSummary": "ニュース全体の簡潔な要約（3〜5文）",
  "themes": [
    {
      "topic": "テーマ名",
      "description": "テーマの説明",
